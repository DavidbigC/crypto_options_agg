...
function OptionRow({ call, put, strike, spotPrice, isATM, exchange, priceUnit, feesOn }: OptionRowProps) {
        ...
        <table className="w-full text-xs tabular-nums">
          <thead>
            <tr className="border-b border-rim">
              ...
              <th className="w-16" />
              <th colSpan={8} className="text-center py-1 text-red-600 dark:text-red-400 font-semibold bg-red-50 dark:bg-red-900/20 text-xs">PUTS</th>
            </tr>
